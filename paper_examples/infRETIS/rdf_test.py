...
Calculate RDF (PDF) of the CI-cluster (Ca central) using the infRETIS trajectories
...
# find all path directories (dirs)
...
for d in tqdm(dirs):
	...
	# go through all trajectories in the current dir/accepted
